...
msm8916_DTS_FILES = $(wildcard $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/samsung/msm8916/msm8916-sec*.dts)
...
$(foreach msm8916_DTS_NAME, $(msm8916_DTS_NAMES), \
   $(foreach d, $(msm8916_DTS_FILES), \
      $(DTC) -O dtb -o $(call DTB_FILE,$(d)) -b 0 -i $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/samsung/msm8916/ $(d); \
